<div class="home-page text-center p-5" style="background-color: #f4f4f4;">
    <h2 class="text-uppercase" style="color: #60435f;">Bienvenue sur l'Application de Gestion de Projets</h2>
    <h3><p class="lead" style="color: #9b7b97;">Optimisez vos projets et simplifiez vos processus avec notre outil intuitif.</p></h3>
