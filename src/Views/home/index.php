<div class="home-page text-center p-5" style="background-color: #f4f4f4;">
    ...
    <div class="button-group mt-4">
        ...
        <a href="/clients/list" class="btn" style="background-color: #6e3f56; color: white; padding: 10px 20px; border-radius: 25px; margin-right: 10px;">Gestion des clients</a>
        <a href="/projects" class="btn" style="background-color: #4b3550; color: white; padding: 10px 20px; border-radius: 25px; margin-right: 10px;">Gestion des Projets</a>
